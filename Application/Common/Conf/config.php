...
return array(
    ...
    //***********************************URL设置**************************************
    'MODULE_ALLOW_LIST' => array('Admin', 'Home'), //允许访问列表
...
//***********************************auth设置**********************************
    ...
    'DATA_CACHE_TYPE' => env('CACHE_TYPE', 'File'), // 数据缓存类型（默认File，可选Memcached）
    'DATA_CACHE_PATH' => RUNTIME_PATH . 'Cache/',  // File缓存目录
